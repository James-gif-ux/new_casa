                ...
                <div class="row">
                    ...
                    <div class="contact-grid" style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1fr 2fr; gap: 3rem; position: relative;">
                        ...
                        <div style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; position: relative; z-index: 1;"
                            ...
                            <h3 style="color:rgb(192, 126, 94); font-size: 1.8rem; margin-bottom: 2rem; font-family: 'impact'; border-bottom: 2px solid rgb(192, 126, 94); padding-bottom: 1rem;">Find Us</h3>
                            ...
                            <div style="margin-bottom: 2rem; transition: all 0.3s ease;" onmouseover="this.style.transform='translateX(10px)'" onmouseout="this.style.transform='translateX(0)'">
                                <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                                    <i class="fas fa-map-marker-alt" style="color:rgb(192, 126, 94); font-size: 1.5rem; margin-right: 1rem;"></i>
                                    <h4 style="color: rgb(192, 126, 94); font-size: 1.2rem;">Address</h4>
                                </div>
                            ...
                            <div style="margin-bottom: 2rem; transition: all 0.3s ease;" onmouseover="this.style.transform='translateX(10px)'" onmouseout="this.style.transform='translateX(0)'">
                                <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                                    <i class="fas fa-phone" style="color: rgb(192, 126, 94); font-size: 1.5rem; margin-right: 1rem;"></i>
                                    <h4 style="color: rgb(192, 126, 94); font-size: 1.2rem;">Phone</h4>
                                </div>
                            ...
                            <div style="margin-bottom: 2rem; transition: all 0.3s ease;" onmouseover="this.style.transform='translateX(10px)'" onmouseout="this.style.transform='translateX(0)'">
                                <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                                    <i class="fas fa-envelope" style="color: rgb(192, 126, 94); font-size: 1.5rem; margin-right: 1rem;"></i>
                                    <h4 style="color:rgb(192, 126, 94); font-size: 1.2rem;">Email</h4>
                                </div>
                        ...
                        <!-- Contact Form Side -->
                        <div style="background: white; padding: 3rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(192, 38, 38, 0.1); position: relative; z-index: 1;">
                        <form method="POST" action="contact.php" style="display: grid; gap: 1.5rem;">
                                <div class="input-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                                    <div style="position: relative;">
                                        ...
                                        <input type="text" name="name" placeholder="Your Name" required 
                                            style="padding: 1rem 1rem 1rem 3rem; border: 2px solid rgb(192, 126, 94); border-radius: 8px; font-size: 1rem; width: 100%;">
                                    </div>
                                    <div style="position: relative;">
                                ...
                                <div style="position: relative;">
                                    ...
                                    <textarea name="message" placeholder="Your Message" required 
                                        style="padding: 1rem 1rem 1rem 3rem; border: 2px solid rgb(192, 126, 94); border-radius: 8px; font-size: 1rem; min-height: 150px; resize: vertical; width: 100%;"></textarea>
                                </div>
                                <button type="submit" 
                                    style="padding: 1rem 2rem; background: linear-gradient(45deg,rgb(119, 77, 56), #ff8243); 
