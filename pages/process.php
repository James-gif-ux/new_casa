<?php
	...
	$page_info['page'] = 'process'; //for page that needs to be called
	$page_info['sub_page'] = isset($_GET['sub_page'])? $_GET['sub_page'] : 'process'; //for function to be loaded
